...
<head>
    ...
    <title>Quiz Selection Page</title>
    <style>
        body {
            ...
            align-items: center;
            background: linear-gradient(to bottom, #f4bdc7, #e4e4cc, #d3abc7);
            /* Slightly darker tones: soft pink to beige to soft purple */
        ...
        .page {
            ...
            line-height: 5.2rem;
            padding: 0rem 1.5rem 2.3rem 4.5rem;
        }
        ...
        .page:hover::before,
        .page:hover::after {
            box-shadow: 0 20px 14px rgba(0, 0, 0, 0.4);
        }

        .margin {
            position: absolute;
            border-left: 1.5px solid #d88;
            height: 100%;
            left: 3.3rem;
            top: 0;
        }
...
<body>
    ...
    <div class="container">
        ...
        <div class="page">
            <div class="margin"></div>
            <h>A STORY-BASED QUIZ</h>
            <p>Welcome to our quiz on moral values! This quiz is based on the story video you are going to watch. The story highlighted important moral values that are essential in our everyday lives. Enjoy the process of learning and reflecting on these important values.</p>
            <a href="quizvideo.php"><button>
                    START
                    <div class="icon-1">
                        <svg xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 26.3 65.33" style="shape-rendering:geometricPrecision; text-rendering:geometricPrecision; image-rendering:optimizeQuality; fill-rule:evenodd; clip-rule:evenodd" version="1.1" xml:space="preserve" xmlns="http://www.w3.org/2000/svg">
                            <defs></defs>
